...
const readingTime = Math.ceil((word_count || 0 /200))
  ...
  return <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to-white"><BigGradient className="from-rose-400 via-rose-300 to-orange-200"/>
