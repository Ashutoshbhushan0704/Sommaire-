...
return <div className='flex flex-col gap-2 mb-6 sticky top-0 pt-2 pb-4 background/80 backdrop-blur-xs z-10'>
...
export function SummaryViewer({ summary }: { summary: string }) {
  ...
  return (
    <Card className="relative px-2 h-[500px] sm:h-[600px] lg:h-[700px] w-full xl:w-[600px] overflow-hidden
