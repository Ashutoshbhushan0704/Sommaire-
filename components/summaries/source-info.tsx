...
export function SourceInfo({fileName,originalFileUrl,title,summaryText,createdAt,original_file_url}:{fileName:string; originalFileUrl:string;title:string;summaryText:string;createdAt:string;original_file_url:string}){
